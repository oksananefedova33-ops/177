...
// Если 1 — SEO-метки/HTML lang берём из языка самой страницы; если 0 — из модалки (единый язык)
        ...
        foreach ($pages as $page) {
            ...
            foreach ($languages as $lang) {
                if ($lang === $primaryLang) {
                    ...
                    $html = generatePageHTML($pdo, $page, $lang, $pageTrans, $usedFiles, $languages, $primaryLang, $seoLangForPage);
